        ...
        <div className='shippingBox'>
          <h2 className='shippingHeading'>Shipping Details</h2>
            <form className='shippingForm' encType='multipart/form-data' onSubmit={shippingSubmit}>
              ...
              <div>
                <PinDropIcon/>
                <input type="number" placeholder='Pin Code' required value={pincode} onChange={(e)=>setPincode(e.target.value)} size="6">
                </input>
              </div>
              ...
              <div>
                <PublicIcon/>
                <select type="text"  required value={country} onChange={(e)=>setCountry(e.target.value)}>
              ...
              {country && (
                <div>
                   <select type="text"  required value={state} onChange={(e)=>setState(e.target.value)}>
